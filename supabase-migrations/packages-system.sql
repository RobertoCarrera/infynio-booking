-- Migración para el sistema de paquetes de clases
...
-- 3. Insertar paquetes basados en la imagen proporcionada

-- Paquetes MAT FUNCIONAL
INSERT INTO packages (name, class_type, class_count, price, is_single_class, is_personal) VALUES
('4 CLASES AL MES', 'MAT_FUNCIONAL', 4, 60.00, FALSE, FALSE),
('8 CLASES AL MES', 'MAT_FUNCIONAL', 8, 105.00, FALSE, FALSE),
('12 CLASES AL MES', 'MAT_FUNCIONAL', 12, 135.00, FALSE, FALSE),
('CLASE SUELTA', 'MAT_FUNCIONAL', 1, 18.00, TRUE, FALSE),
('CLASE PERSONALIZADA', 'MAT_FUNCIONAL', 1, 35.00, TRUE, TRUE);

-- Paquetes REFORMER
INSERT INTO packages (name, class_type, class_count, price, is_single_class, is_personal) VALUES
('4 CLASES AL MES', 'REFORMER', 4, 80.00, FALSE, FALSE),
('8 CLASES AL MES', 'REFORMER', 8, 130.00, FALSE, FALSE),
('12 CLASES AL MES', 'REFORMER', 12, 160.00, FALSE, FALSE),
('CLASE SUELTA', 'REFORMER', 1, 25.00, TRUE, FALSE),
('CLASE PERSONALIZADA', 'REFORMER', 1, 50.00, TRUE, TRUE);
...
-- 9. Función para gestionar rollover mensual (se ejecutaría con un cron job)
...
-- 10. Función para usar una clase
...
-- 11. Función para cancelar una clase (devolver la clase)
